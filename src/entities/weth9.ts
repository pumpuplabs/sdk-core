...
export const WETH9: { [chainId: number]: Token } = {
  ...
  [763373]: new Token(763373, '0x4200000000000000000000000000000000000006', 18, 'WETH', 'Wrapped Ether'),
  [57073]: new Token(5707, '0x4200000000000000000000000000000000000006', 18, 'WETH', 'Wrapped Ether')
}
